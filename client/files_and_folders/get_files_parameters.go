...
// WithPath adds the path to the get files params
func (o *GetFilesParams) WithPath(path string) *GetFilesParams {
	o.SetPath(path)
	return o
}

// SetPath adds the path to the get files params
func (o *GetFilesParams) SetPath(path string) {
	o.Path = path
}
