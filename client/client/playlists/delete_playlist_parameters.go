...
// WithPlaylistUID adds the playlistUID to the delete playlist params
func (o *DeletePlaylistParams) WithPlaylistUID(playlistUID string) *DeletePlaylistParams {
	o.SetPlaylistUID(playlistUID)
	return o
}

// SetPlaylistUID adds the playlistUid to the delete playlist params
func (o *DeletePlaylistParams) SetPlaylistUID(playlistUID string) {
