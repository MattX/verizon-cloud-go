...
type CreateShareParams struct {
	...
	*/
	CreateShare *models.CreateShareRequest
...
// WithCreateShare adds the createShare to the create share params
func (o *CreateShareParams) WithCreateShare(createShare *models.CreateShareRequest) *CreateShareParams {
	o.SetCreateShare(createShare)
	return o
}

// SetCreateShare adds the createShare to the create share params
func (o *CreateShareParams) SetCreateShare(createShare *models.CreateShareRequest) {
	o.CreateShare = createShare
}
...
func (o *CreateShareParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.CreateShare != nil {
		if err := r.SetBodyParam(o.CreateShare); err != nil {
			return err
		}
	}
