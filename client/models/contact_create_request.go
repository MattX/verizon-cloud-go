...
// ContactCreateRequest contact create request
//
// swagger:model contact_create_request
...
// Validate validates this contact create request
func (m *ContactCreateRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContactCreateRequest) validateAddress(formats strfmt.Registry) error {
...
func (m *ContactCreateRequest) validateEmail(formats strfmt.Registry) error {
...
func (m *ContactCreateRequest) validateIm(formats strfmt.Registry) error {
...
func (m *ContactCreateRequest) validateTel(formats strfmt.Registry) error {
...
// ContextValidate validate this contact create request based on the context it is used
func (m *ContactCreateRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ContactCreateRequest) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContactCreateRequest) contextValidateEmail(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContactCreateRequest) contextValidateIm(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContactCreateRequest) contextValidateTel(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ContactCreateRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContactCreateRequest) UnmarshalBinary(b []byte) error {
	var res ContactCreateRequest
