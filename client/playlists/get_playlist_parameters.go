...
// WithPlaylistUID adds the playlistUID to the get playlist params
func (o *GetPlaylistParams) WithPlaylistUID(playlistUID string) *GetPlaylistParams {
	o.SetPlaylistUID(playlistUID)
	return o
}

// SetPlaylistUID adds the playlistUid to the get playlist params
func (o *GetPlaylistParams) SetPlaylistUID(playlistUID string) {
