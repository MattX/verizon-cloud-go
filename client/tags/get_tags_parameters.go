...
type GetTagsParams struct {
	...
	/* Path.
	   ...
	   The path to the file or folder for which tags need to be retrieved
	*/
	Path string
...
// WithPath adds the path to the get tags params
func (o *GetTagsParams) WithPath(path string) *GetTagsParams {
	o.SetPath(path)
	return o
}

// SetPath adds the path to the get tags params
func (o *GetTagsParams) SetPath(path string) {
	o.Path = path
}
