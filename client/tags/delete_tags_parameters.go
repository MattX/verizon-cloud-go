...
// WithCreateVersion adds the createVersion to the delete tags params
func (o *DeleteTagsParams) WithCreateVersion(createVersion *bool) *DeleteTagsParams {
	o.SetCreateVersion(createVersion)
	return o
}

// SetCreateVersion adds the createVersion to the delete tags params
func (o *DeleteTagsParams) SetCreateVersion(createVersion *bool) {
	o.CreateVersion = createVersion
}

// WithURI adds the uri to the delete tags params
func (o *DeleteTagsParams) WithURI(uri string) *DeleteTagsParams {
	o.SetURI(uri)
	return o
}

// SetURI adds the uri to the delete tags params
func (o *DeleteTagsParams) SetURI(uri string) {
	o.URI = uri
}
